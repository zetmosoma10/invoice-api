function generateReminderInvoiceContent(
  clientName,
  invoiceNumber,
  amountDue,
  paymentDue
  ...
  <html>
    <body style="font-family: Arial, sans-serif; color: #333;">
      <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        <h2 style="color: #FF6347;">Hello ${clientName},</h2>
        <p>This is a friendly reminder that your invoice is due soon.</p>
        <p><strong>Invoice Number:</strong> ${invoiceNumber}</p>
        <p><strong>Amount Due:</strong> R${amountDue}</p>
        <p><strong>Due Date:</strong> ${paymentDue}</p>
...
export default generateReminderInvoiceContent;
